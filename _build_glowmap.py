"""
Rebuild night-culture-glowmap.png from whatever's currently in dots.json.
...
img.save("night-culture-glowmap.png", optimize=True, quality=92)

import os
sz = os.path.getsize("night-culture-glowmap.png")
print(f"Rebuilt night-culture-glowmap.png with {dots['count']} dots — {target_w}×{target_h} ({sz/1024:.0f} KB)")
